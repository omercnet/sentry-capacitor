...
/**
 * Configuration options for the Angular ErrorHandler
 */
export interface ErrorHandlerOptions {
  ...
  /**
   * Custom implementation of error extraction from the raw value captured by Angular.
...
): CapacitorAngularErrorHandler {
  return new CapacitorAngularErrorHandler(config);
}
